...
// src/tones.js
var TONES = ["success", "danger", "warning", "info", "tip", "muted"];
var ALIASES = {
  ok: "success",
  pass: "success",
  error: "danger",
...
var COLOR_NAME = /^[a-zA-Z][a-zA-Z0-9]*$/;
...
function toneAttrs(meta, escapeHtml2) {
  const custom = meta.color ? " cm-custom" : "";
  const tone = meta.tone ? ` data-tone="${meta.tone}"` : "";
  const style = meta.color ? ` style="--fg:${escapeHtml2(meta.color)}"` : "";
  return { custom, tone, style };
}
function inlinePlugin(md, enabled) {
...
function criticRule(state, silent) {
  const start = state.pos;
  const src = state.src;
  if (src.charCodeAt(start) !== OPEN2) return false;
...
function makeRule2(enabled) {
  return function chromaContainer(state, startLine, endLine, silent) {
    ...
    for (; ; ) {
      ...
      while (p < lmax && (state.src.charCodeAt(p) === 32 || state.src.charCodeAt(p) === 9)) p++;
      if (p < lmax) continue;
      autoClosed = true;
      break;
    }
...
function containerPlugin(md, enabled) {
  md.block.ruler.before("fence", "cm_container", makeRule2(enabled), {
...
var GITHUB_LIGHT = {
  ...
  "--cm-success-bg": "#dafbe1",
  "--cm-success-bd": "#2da44e",
  "--cm-danger-fg": "#cf222e",
  "--cm-danger-bg": "#ffebe9",
  "--cm-danger-bd": "#ff8182",
  "--cm-warning-fg": "#9a6700",
  "--cm-warning-bg": "#fff8c5",
  "--cm-warning-bd": "#d4a72c",
  "--cm-info-fg": "#0969da",
  "--cm-info-bg": "#ddf4ff",
  "--cm-info-bd": "#54aeff",
  "--cm-tip-fg": "#0f7b6c",
...
var GITHUB_DARK = {
  ...
  "--cm-success-bg": "#12261e",
  "--cm-success-bd": "#238636",
  "--cm-danger-fg": "#f85149",
  "--cm-danger-bg": "#25171c",
  "--cm-danger-bd": "#da3633",
  "--cm-warning-fg": "#d29922",
  "--cm-warning-bg": "#272115",
  "--cm-warning-bd": "#9e6a03",
  "--cm-info-fg": "#58a6ff",
  "--cm-info-bg": "#0d2233",
  "--cm-info-bd": "#1f6feb",
  "--cm-tip-fg": "#56d4c3",
...
var OCEAN = {
  ...
  "--cm-success-bd": "#10b981",
  "--cm-danger-fg": "#be123c",
  "--cm-danger-bg": "#ffe4e6",
  "--cm-danger-bd": "#fb7185",
  "--cm-warning-fg": "#a16207",
  "--cm-warning-bg": "#fef9c3",
  "--cm-warning-bd": "#eab308",
  "--cm-info-fg": "#0369a1",
  "--cm-info-bg": "#e0f2fe",
  "--cm-info-bd": "#38bdf8",
  "--cm-tip-fg": "#0f766e",
...
var SUNSET = {
  ...
  "--cm-success-bg": "#ecfccb",
  "--cm-success-bd": "#84cc16",
  "--cm-danger-fg": "#be123c",
  "--cm-danger-bg": "#fff1f2",
  "--cm-danger-bd": "#fb7185",
  "--cm-warning-fg": "#c2410c",
  "--cm-warning-bg": "#ffedd5",
  "--cm-warning-bd": "#fb923c",
  "--cm-info-fg": "#7e22ce",
  "--cm-info-bg": "#f3e8ff",
  "--cm-info-bd": "#c084fc",
  "--cm-tip-fg": "#be185d",
...
var MONOCHROME = {
  ...
  "--cm-success-bg": "#f5f5f5",
  "--cm-success-bd": "#737373",
  "--cm-danger-fg": "#171717",
  "--cm-danger-bg": "#e5e5e5",
  "--cm-danger-bd": "#525252",
  "--cm-warning-fg": "#404040",
  "--cm-warning-bg": "#fafafa",
  "--cm-warning-bd": "#a3a3a3",
  "--cm-info-fg": "#262626",
  "--cm-info-bg": "#f5f5f5",
  "--cm-info-bd": "#737373",
  "--cm-tip-fg": "#404040",
...
function resolveTheme(input = "github-light") {
  const config2 = typeof input === "string" ? { preset: input } : input;
  ...
  const presetName = config2.preset || "github-light";
  const preset = THEME_PRESETS[presetName];
  if (!preset) throw new Error(`unknown theme preset "${presetName}"`);
  const variables = { ...preset };
  for (const [tone, slots] of Object.entries(config2.tones || {})) {
...
function applyTheme(target, input) {
